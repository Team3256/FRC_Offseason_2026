...
public class ClimbConstants {
  ...
  public static final double stowPosition = -95; // decreased to allow pullback
  public static final double pullPosition = -100; // pulls in
  public static final double readyPosition = -28; // move out to hook
